...
const [value, setValue] = useState("")
  ...
  return (
    ...
    <div className="my-[5rem] bg-[#219ebc] rounded-lg drop-shadow-lg w-[20rem]">
      <div className="flex justify-center my-[2rem]"><input type="text" value={value} placeholder="0" className="outline-none text-center text-blue-800 rounded-lg p-2 w-[16rem]"/></div>
      ...
      <input type="button" className="bg-[#0077b6] p-2 fonts-bold text-2xl text-[#ffffff] rounded-lg cursor-pointer hover:bg-[#48cae4]" value={"-"} onClick={e=> setValue(value + e.target.value)} />
      <input type="button" className="bg-[#0077b6] p-2 fonts-bold text-2xl text-[#ffffff] rounded-lg cursor-pointer hover:bg-[#48cae4]" value={"/"} onClick={e=> setValue(value + e.target.value)} />
      <input type="button" className="bg-[#0077b6] p-2 fonts-bold text-2xl text-[#ffffff] rounded-lg cursor-pointer hover:bg-[#48cae4]" value={"x"} onClick={e=> setValue(value + e.target.value)} />
